...
public class DanceTeamInit : MonoBehaviour
{
    ...
    void InitTeams()
    {
        ...
        teamA.SetTroupeName("BlueTeam");
        teamB.SetTroupeName("RedTeam");
        ...
        //Fix direction later
        teamA.InitaliseTeamFromNames(dancerPrefab, -1, nameGenerator.GenerateNames(3));
        teamB.InitaliseTeamFromNames(dancerPrefab, 1, nameGenerator.GenerateNames(3));
    }
}
