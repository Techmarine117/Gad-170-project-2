...
public class FightManager : MonoBehaviour
{
    ...
    IEnumerator Attack(Character lhs, Character rhs)
    {
        ...
        float outcome = (lhs.style + lhs.luck - lhs.rhythm) - (rhs.style + rhs.luck - rhs.rhythm);
        ...
        BattleLog.print("The winner is " + winner.charName.firstName + " " + winner.charName.nickname + " " + winner.charName.lastName + "!!!!");
